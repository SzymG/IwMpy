...
class Window(QtWidgets.QMainWindow):
    ...
    def initGUI(self):
        ...
        btn_start.setGeometry(400, 690, 210, 50)
        btn_start.clicked.connect(self.start)

        self.label1.setGeometry(120, 575, 220, 100)
        self.label2.setGeometry(400, 575, 220, 100)
        self.label3.setGeometry(680, 575, 220, 100)
        ...
        self.s1.setGeometry(30, 520, 300, 50)
        ...
        self.s2.setGeometry(350, 520, 300, 50)
        ...
        self.s3.setGeometry(670, 520, 300, 50)
        self.s3.valueChanged.connect(self.valuechange_3)

        self.slider_label1.setGeometry(210, 600, 50, 50)
        ...
        self.slider_label2.setGeometry(560, 600, 50, 50)
        ...
        self.slider_label3.setGeometry(920, 600, 50, 50)
